...
vCAN2Stat = Display_CAN_STATUS; 
  ...
  /*Override Mode*/
  if ((I_Button_Down == 1) && (I_Button_04 ==1) && (V_Screen_Number == Screen_Screen3)) 
    {
      tonOverride_STATUS = TRUE;
      if (tonOverride_VALUE ==0)
       {
          vOverride = TRUE;
          tonOverride_STATUS = FALSE;
       }
    } 
   else
    {
       tonOverride_STATUS = FALSE;
       tonOverride_VALUE = 10;
    }
 ...
 /* Calculate Pump Hydraulic Pressure*/
	...
	/***************************TEMPERATURE*************************************/
		...
		/* Calculate Hydraulic Temp at P port*/
				...
				else if ((ai_P_Temp < 1039) && (ai_P_Temp> 450))  /*Set min (0) if slightly under range*/
				{	
					vTempP = 0;
					qTemp_P_Fault = FALSE;
				}
				...
				else if ((ai_LS_Temp < 1039) && (ai_LS_Temp> 450))  /*Set min (0) if slightly under range*/
				{	
					vTempLS = 0;
					qTemp_LS_Fault = FALSE;
				}
...
void Engine_Control (void)
{
  ...
  /*Calculate Engine Water Temp*/ 
    ...
    /*Set Idle Modes*/
      ...
      else if (((qHighHydTemp == TRUE) || (vHiPSIStop == TRUE) || (qLowHydOil == TRUE)) && (vOverride == FALSE))
      {
        qEngineStop = 1;
      } 
      else if (((qRC1Estop == 0) && (qRC2Estop == 0))
        && (((qHighHydTemp == FALSE) && (qLowHydOil == FALSE) && (tonServScreen_VALUE == 0) && (vHiPSIStop == FALSE)) || (vOverride == TRUE)) 
...
{ 
  ...
  else
  {
	...
	else if (doRegInterlock_VALUE > 0)
	{
		vAllRegenStat = 1;
	}
	else
    ...
    /*Disable engine warnings at start up*/
    
    if (doIgnition_VALUE == 0) 
    {
      tonWarnDisable_VALUE = 14;
    }
    
    if (tonWarnDisable_VALUE > 0)
    {
       tonWarnDisable_STATUS = TRUE;
    }
    else
    {
       tonWarnDisable_STATUS = FALSE;
    }
    
    if ((CAN_Red_VALUE == 1) && (tonWarnDisable_VALUE == 0))
    {
      As.RedLight = TRUE;
    }
    else
    {
      ...
      if ((CAN_Amber_VALUE == 1) && (tonWarnDisable_VALUE == 0))
    {
      As.AmberLight = TRUE;
    }
    else
    ...
    if ((CAN_Regen_VALUE == 1) && (tonWarnDisable_VALUE == 0))
    {
      As.RegenLight = TRUE;
    }
    else
    {
     ...
     if ((CAN_HEGT_VALUE == 1) && (tonWarnDisable_VALUE == 0))
    {
      As.HEGTLight = TRUE;
    }
    else
    {
     ...
     if ((CAN_Inhibit_VALUE == 1) && (tonWarnDisable_VALUE == 0))
    {
      As.InhibitLight = TRUE;
    }
    else
    {
      As.InhibitLight = FALSE;
    }
   ...
   if ((As.RedLight == 1) && (tonMessage1_VALUE != 0))
		{            
			V_WarningNumber = 1;
			tonMessage1_STATUS = TRUE;
		}
	else if ((As.AmberLight == 1) && (tonMessage2_VALUE != 0))
		{
			V_WarningNumber = 2;
			tonMessage2_STATUS = TRUE;
		}
	else if ((As.RegenLight == 1) && (tonMessage3_VALUE != 0))
		{
			V_WarningNumber = 3;
			tonMessage3_STATUS = TRUE;
		}
	else if ((As.HEGTLight == 1) && (tonMessage4_VALUE != 0))
		{
			V_WarningNumber = 4;
	...
	else if ((As.InhibitLight == TRUE) && (tonMessage19_VALUE != 0))
		{
			V_WarningNumber = 19;
	...
	else if ((qService100 == TRUE) && (tonMessage26_VALUE != 0))
		{
			V_WarningNumber = 26;
			tonMessage26_STATUS = TRUE;
		}	
	else if ((qService250 == TRUE) && (tonMessage27_VALUE != 0))
		{
			V_WarningNumber = 27;
			tonMessage27_STATUS = TRUE;
		}	
	else if ((vOverride == TRUE) && (tonMessage28_VALUE != 0))
		{
			V_WarningNumber = 28;
			tonMessage28_STATUS = TRUE;
		}	
	else 
	{
		if ((As.RedLight == 1)||(As.AmberLight == 1)||(As.RegenLight == 1)||(As.HEGTLight == 1)||(As.InhibitLight == 1)
				...
				||(vLowRegenTemp == TRUE) ||(vRegenCond == TRUE) ||(vEmergencyReg == TRUE)  ||(vRecoveryReg == TRUE) 
				||(vPressYes == TRUE)||(qService100 == TRUE)||(qService250 == TRUE) || (vOverride == TRUE))
		{
		}
		else
		{
	  ...
	  tonMessage26_STATUS = FALSE;
		tonMessage27_STATUS = FALSE;
		tonMessage28_STATUS = FALSE;
    ...
    tonMessage26_VALUE = 5;
    tonMessage27_VALUE = 5;
    tonMessage28_VALUE = 5;
	}
